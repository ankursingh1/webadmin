...
<div class="navigation_bar">
    ...
    <span style="position:relative;">
      ...
      <?php if($_SESSION['user_id']!="" && $cou!=''){ ?>
       ...
       <a href="cart.php"><img src="images/cart_orange_09.jpg" style="margin-top:-4px;" alt=""></a>

	  <span style="position:absolute; left:108px; top:-4px; -webkit-border-radius: 50%; -moz-border-radius: 50%; border-radius: 50%; width:15px; height:15px; text-align:center; background-color:#fff;font-size:12px; color:#000;"><?php echo $cou; ?></span>
      <?php }else{?>
      <a href="cart.php"><img src="images/cart_orange_09.jpg" style="margin-top:-4px;" alt=""></a>
       <span style="position:absolute; left:150px; top:1px; -webkit-border-radius: 50%; -moz-border-radius: 50%; border-radius: 50%; width:15px; height:15px; text-align:center; background-color:#fff; font-size:12px; color:#000;"><?php echo $cou; ?></span>
...
<div class="signin_blg">
                ...
                <div class="signin_blg_right">
                    ...
                    <div><input type="text" name="log_email" id="log_email" pattern="[^ @]*@[^ @]*" placeholder="Email" required></div>
