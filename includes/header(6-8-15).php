...
<div class="contact_popup">
	...
	<div class="contact_popup">
            ...
            <div class="facebook_blg" style="font-family: 'CenturyGothicRegular'; color: #908f8f;">
                ...
                <div style="float:right;"><b>*</b>All Fields Are Mandatory </p></div>
           ...
           <!-- <div class="or">
            ...
            <div class="form_blg">
                ...
                <div class="name">
					...
					<input type="text" placeholder="Church url"    name="church_website" id="church_website" style="margin-top:0px;">
               ...
               <textarea name="artist_biodata" id="artist_biodata" required placeholder="Artist Biodata*" style="width:95%;" ></textarea> 
