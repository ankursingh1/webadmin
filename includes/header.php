...
window.location="<?=SITEURL?>/content.php?id=9";
...
$art_obj->update_applicant_des($_POST);
 ...
 //print_r($cart);
	  ...
	  $countress=mysql_query("select * from tb_frmessages where flag='0' and sent_id='".$_SESSION['user_id']."'");
	  $countres=mysql_num_rows($countress);
      $resuser=mysql_fetch_array($countress);
	  //$countres = $callConfig->getCount($queryuser);
...
<header class="full_wrapper">
	...
	<div class="site_container">
        	...
        	<div class="logo" style="bor">
            	...
            	<a href="index.php"><img src="images/logo_03.jpg" alt="logo"<?php /*?> style="margin-left:-40px; height:70px;"<?php */?>></a>
...
<div class="navigation_bar">
     ...
     <div class="mobile_menuicon"><img src="images/mobile_menu.png"></div>
    	...
    	<div class="nav">
        	...
        	<ul id="menu">
                ...
                <li class="submenu1"><a href="#">RESOURCES &#9662;</a>
				
				<ul>
               
				<?php 
				//print_r($resources);
				foreach($resources as $allres) { 
				if($allres->id=='4'){
                                    ?>
					<?php }else if($allres->id=='3'){?>
					<li><a href="videos.php"><?php echo $allres->title;?></a></li>	
					<?php }else{?>
					<li><a href="resources.php?id=<?php echo $allres->id; ?>"><?php echo $allres->title;?></a></li>
					<?php } }?>
                
                 <li><a href="artistfaq.php">FAQ for Artists</a></li>
                 <li><a href="buyerfaq.php">FAQ for Buyers</a></li>
				 </ul>
				</li>
	...
	$res=mysql_fetch_array($query);?>
     ...
     <span><a class="fancybox" href="psignup.php" title="Sign In" >SIGN UP / SIGN IN</a>&nbsp;&nbsp;</span>
		...
		//print_r($_SESSION['user_id']);echo"<br/>";echo($countres);echo "<br/>";print_r($resuser['flag']);
		if($_SESSION['user_id']!="" && $countres!=''){ //echo "ifff";?>
		 	<a href="messages.php" style="position:relative;" onClick="updateArea1(<?php echo $countres;?>,<?php echo $_SESSION['user_id']?>);">
				<img src="images/chat.jpg" style="margin-top:-4px;">
				<span style="position:absolute; left:18px; top:-9px; -webkit-border-radius: 50%; -moz-border-radius: 50%; border-radius: 50%; width:15px; height:15px; text-align:center; background-color:#fff;font-size:12px; color:#000;"><?php echo $countres; ?></span>	
			</a>
		<?php }else{ //echo "elsee";?>
	 			<a href="messages.php" style="position:relative;">
				<img src="images/chat.jpg" style="margin-top:-4px;">
				<span style="position:absolute; left:16px; top:-9px; -webkit-border-radius: 50%; -moz-border-radius: 50%; border-radius: 50%; width:15px; height:15px; text-align:center; background-color:#fff; font-size:12px; color:#000;"><?php echo 0; ?></span>	
			</a>
		  <?php }} ?>
...
<script>
	function updateArea1(count,id){
		...
		xmlhttp.onreadystatechange=function()
		{
		  ...
		  xmlhttp.open("GET", "updatedb.php?id="+id+"&count="+count, true);
		  xmlhttp.send();
	}
</script>
<div id="hello"></div>
...
<div class="site_container2">
	...
	<div class="contact_popup">
            ...
            <div style="float:right; margin-top:0px;"><p>All fields with(<b>*</b>) are mandatory </p></div>
            ...
            <div class="form_blg">
                ...
                <input type="email" placeholder="Email Address*" name="email" onchange ='getemail(this.value)' required>    
   ...
   <input type="password" placeholder="Password*" name="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" onChange="form.cpassword.pattern = this.value;" required title="Please enter alphanumeric">

         <input type="password" placeholder="Confirm Password*" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"  name="cpassword"  onBlur="return c_passw(this.value);" required title="Please enter alphanumeric">
...
<!--venkat Next dont remove from here-->	     
         ...
         onKeyDown='textCounter(this.form.art_desc<?php echo $i;?>,this.form.remLen<?php echo $i;?>,10000);' 

         onKeyUp='textCounter(this.form.art_desc<?php echo $i;?>,this.form.remLen<?php echo $i;?>,10000);'></textarea>

         <input readonly type=text name=remLen<?php echo $i;?> size='2px' maxlength=2 value='10000' style="float:left; height: 24px;width: 56px;"> 
         ...
         <span style="color:#105DAF;font-family: 'CenturyGothicRegular';float:left;margin-left: 2px;">Characters Left</span></font><br />
