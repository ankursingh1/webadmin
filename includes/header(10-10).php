...
<header class="full_wrapper">
	...
	<div class="site_container">
        	...
        	<div class="logo" style="bor">
            	...
            	<a href="index.php"><img src="images/logo_03.png" alt="logo" <?php /*?>style="margin-left:-40px; height:70px;"<?php */?>></a>
...
<div class="site_container2">
   ...
   <input type="password" placeholder="Password*" name="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" onChange="form.cpassword.pattern = this.value;" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
