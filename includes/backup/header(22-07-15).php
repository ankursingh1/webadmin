	...
	<div class="mid_wrap">
     ...
     <div class="mobile_menuicon"><img src="images/mobile_menu.png"></div>
		...
		<?php } else {?>
		  ...
		  <?php echo ucfirst($res['first_name'])." ". ucfirst($res['last_name']);?></a>
	...
	<div class="contact_popup">
           ...
           <!-- <div class="or">
            ...
            <!--    <button id="add_more" class="add_field_button upload">Add More Fields</button>   -->
			    ...
			    <div style="color: #908f8f; margin-left: 9px;"><h4>Please upload 5 examples of your art.</h4></div><br>
...
<!--venkat Next dont remove from here-->	     
			...
			<?php
			 ...
			 $qq=mysql_query("select * from tb_artist_images where artist_id=".$_GET['id']);
         ...
         <span style="color:#105DAF;">characters left</span></font><br />
	  ...
	  Your application has been submitted, and is pending review!  We will send you an e-mail soon letting you know the status of your application. <br> Thanks,</br>
