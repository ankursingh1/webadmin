...
<div class="navigation_bar">
    ...
    <span style="position:relative;">
      ...
      <?php if($_SESSION['user_id']!="" && $cou!=''){ ?>
       ...
       <a href="cart.php"><img src="images/cart_orange_09.png" style="margin-top:-4px;" alt=""></a>

	  <span style="position:absolute; left:104px; top:-4px; -webkit-border-radius: 50%; -moz-border-radius: 50%; border-radius: 50%; width:15px; height:15px; text-align:center; background-color:#fff;font-size:12px; color:#000;"><?php echo $cou; ?></span>
      <?php }else{?>
      <img src="images/cart_orange_09.png" style="margin-top:0px;" alt="">
       <span style="position:absolute; left:150px; top:-5px; -webkit-border-radius: 50%; -moz-border-radius: 50%; border-radius: 50%; width:15px; height:15px; text-align:center; background-color:#fff; font-size:12px; color:#000;"><?php echo $cou; ?></span>
