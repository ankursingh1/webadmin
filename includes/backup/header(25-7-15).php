...
<header class="full_wrapper">
	...
	<div class="site_container">
        	...
        	<div class="logo">
            	...
            	<a href="index.php"><img src="images/logo_03.png" alt="logo" id="Image1" style=" margin-left:-10px; height:65px;"></a>
	...
	<div class="mid_wrap">
     ...
     <div class="mobile_menuicon"><img src="images/mobile_menu.png"></div>
      ...
      <!-- <span style="position:relative;">-->
	   ...
	   <img src="images/cart_orange_09.png" alt="">



	  <!-- <span style="position:absolute; right:0px; top:0px; -webkit-border-radius: 50%; -moz-border-radius: 50%; border-radius: 50%; width:20px; height:20px; text-align:center; background-color:#fff; color:#000;">0</span>
           ...
           <!-- <div class="or">
            ...
            <div class="form_blg">
			   ...
			   <input type="hidden" name="fvalue" id="fvalue">
                ...
                <div class="input_fields_wrap" style="color:#908f8f;font-family:Conv_centuryGothic_bold">
...
<div style="color: #908f8f; margin-left: 9px;"><h4 style="font-family:Conv_centuryGothic_bold">Please upload 5 examples of your art.</h4></div><br>
			 ...
			 <div  class="input_fields_wrap" style="color: #908f8f;font-family:Conv_centuryGothic_bold">
				...
				<input name="art<?php echo $i;?>" type="file" id="file" required/></div><br>
...
<!--venkat Next dont remove from here-->	     
         ...
         <span style="color:#105DAF;font-family:Conv_centuryGothic_bold">characters left</span></font><br />
	...
	<p style="font-family:Conv_centuryGothic_bold">  Your application has been submitted, and is pending review!  We will send you an e-mail soon letting you know the status of your application. <br> Thanks,</br></p>
...
<b style="color:#0B55A6; font-family:Conv_centuryGothic_bold">The Prophetic Creations Team.</b>
	...
	<p style="font-family:Conv_centuryGothic_bold"> Your account created successfully.
